...
class FcmFirstDemo extends StatefulWidget {
  @override
  FcmFirstDemoState createState() => FcmFirstDemoState();
}
...
class FcmFirstDemoState extends State<FcmFirstDemo> {
  ...
  final String fCreateTime = "createAt";
                                    ...
                                    children: <Widget>[
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                              child: Text(doc[fName], style: tsContent))
                                        ],
                                      ),
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Expanded(
                                              child: SizedBox(height: 50,)) //Text(doc[fPlatform], style: tsContent))
                                        ],
                                      ),
                                      Row(
                                        children: <Widget>[
